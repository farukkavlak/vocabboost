...
VocabBoost does not collect any data, and it has no server.

## What stays on your computer

- The subtitles and the words you look up. The meaning is found by a model that runs
  inside the extension.
- The word log. Each word you look up is saved in your browser with its subtitle, the
  video's title and address, and the time in the video. You can delete entries. If you
  remove the extension, the log is deleted too.
- Your API key, if you add one. It is saved in your browser only and is not synced to
  your Google account.
